...
import { Shield, Key, RefreshCw, CheckCircle, AlertCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="animate-fade-in" style={{ padding: '40px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="glass-card" style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
          ...
          <div>
            <h3 style={{ fontSize: '1.25rem', color: 'white' }}>Token Exchange</h3>
            <p style={{ fontSize: '0.9rem', opacity: 0.6 }}>Step 4: Exchange Authorization Code for Access Token</p>
          </div>
        </div>
        ...
        <form onSubmit={handleExchange}>
          <div style={{ marginBottom: '20px' }}>
            ...
            <input
              ...
              placeholder="Enter the code from Step 3"
        ...
        <div className="glass-card" style={{ background: 'rgba(42, 157, 143, 0.1)', border: '1px solid rgba(42, 157, 143, 0.2)' }}>
          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start', marginBottom: '20px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.9rem', opacity: 0.8, marginTop: '4px' }}>Your tokens have been retrieved successfully.</p>
            </div>
          </div>
          ...
          <div style={{ marginTop: '24px', padding: '16px', background: 'rgba(255,255,255,0.05)', borderRadius: '8px', fontSize: '0.85rem', opacity: 0.7 }}>
            <p><strong>Note:</strong> In a production environment, these tokens would be automatically saved to your database. For this demo, please copy them if you need to use them in other tools.</p>
          </div>
        </div>
      )}
    </div>
